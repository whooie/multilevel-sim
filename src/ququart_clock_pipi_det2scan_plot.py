...
(
    pd.Plotter()
    .colorplot(det1, det2, P_G0.real.T)
    .colorbar()
...
(
    pd.Plotter()
    .colorplot(det1, det2, P_G1.real.T)
    .colorbar()
    .ggrid().grid(False, which="both")
    .set_title("∣G1⟩")
    .set_xlabel("Detuning 1 [MHz]")
...
(
    pd.Plotter()
    .colorplot(det1, det2, P_C0.real.T)
    .colorbar()
    .ggrid().grid(False, which="both")
    .set_title("∣C0⟩")
    .set_xlabel("Detuning 1 [MHz]")
...
(
    pd.Plotter()
    .colorplot(det1, det2, P_C1.real.T)
    .colorbar()
    .ggrid().grid(False, which="both")
    .set_title("∣C1⟩")
    .set_xlabel("Detuning 1 [MHz]")
...
(
    pd.Plotter()
    .colorplot(det1, det2, nbar.real.T)
    .colorbar()
    .ggrid().grid(False, which="both")
    .set_xlabel("Detuning 1 [MHz]")
    .set_ylabel("Detuning 2 [MHz]")
